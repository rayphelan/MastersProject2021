(module
 ...
 (global $assembly/index/arraySize i32 (i32.const 5))
 ...
 (data (i32.const 512) "\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\1a\00\00\00\00\00\00")
 (table $0 1 funcref)
 (export "heapSort" (func $assembly/index/heapSort))
 ...
 (func $assembly/index/swap (param $0 i32) (param $1 i32)
  (local $2 f64)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/index/heapify (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/heapSort (result f64)
  (local $0 i32)
  (local $1 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
