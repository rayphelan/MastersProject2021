(module
 ...
 (global $assembly/index/L (mut i32) (i32.const 0))
 ...
 (func $assembly/index/mSort (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  local.get $1
  i32.lt_s
 ...
 (func $assembly/index/merge (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
