...
declare module "assemblyscript/src/module" {
    ...
    export class Module {
        ...
        sizeType: NativeType);
        private lit;
        static create(useShadowStack: boolean, sizeType: NativeType): Module;
        static createFrom(buffer: Uint8Array, useShadowStack: boolean, sizeType: NativeType): Module;
        ...
        return_call_indirect(tableName: string, index: ExpressionRef, operands: ExpressionRef[] | null, params: NativeType, results: NativeType): ExpressionRef;
