...
module.exports.__wbg_log_8cf946d4de81e632 = typeof console.log == 'function' ? console.log : notDefined('console.log');

const path = require('path').join(__dirname, 'selection_sort_bg.wasm');
