...
module.exports.__wbg_log_ddfaf137067decc6 = typeof console.log == 'function' ? console.log : notDefined('console.log');

const path = require('path').join(__dirname, 'bubble_sort_bg.wasm');
