...
declare module "assemblyscript/src/module" {
    ...
    export namespace NativeType {
        ...
        const Eqref: NativeType;
        const I31ref: NativeType;
        const Dataref: NativeType;
    ...
    export enum UnaryOp {
        ...
        TruncSatF64x2ToI64x2 = 105,
        TruncSatF64x2ToU64x2 = 106,
        ConvertI32x4ToF32x4 = 107,
        ConvertU32x4ToF32x4 = 108,
        ConvertI64x2ToF64x2 = 109,
        ConvertU64x2ToF64x2 = 110,
        ExtendLowI8x16ToI16x8 = 111,
        ExtendHighI8x16ToI16x8 = 112,
        ExtendLowU8x16ToU16x8 = 113,
        ExtendHighU8x16ToU16x8 = 114,
        ExtendLowI16x8ToI32x4 = 115,
        ExtendHighI16x8ToI32x4 = 116,
        ExtendLowU16x8ToU32x4 = 117,
        ExtendHighU16x8ToU32x4 = 118,
        ExtendLowI32x4ToI64x2 = 119,
        ExtendHighI32x4ToI64x2 = 120,
        ExtendLowU32x4ToU64x2 = 121,
        ExtendHighU32x4ToU64x2 = 122,
        ConvertLowI32x4ToF64x2 = 123,
        ConvertLowU32x4ToF64x2 = 124,
        TruncSatZeroF64x2ToI32x4 = 125,
        TruncSatZeroF64x2ToU32x4 = 126,
        DemoteZeroF64x2ToF32x4 = 127,
        PromoteLowF32x4ToF64x2 = 128
    }
    export enum BinaryOp {
        ...
        PminF64x2 = 185,
        PmaxF64x2 = 186,
        NarrowI16x8ToI8x16 = 187,
        NarrowU16x8ToU8x16 = 188,
        NarrowI32x4ToI16x8 = 189,
        NarrowU32x4ToU16x8 = 190,
        SwizzleV8x16 = 191
    }
    ...
    export enum SIMDWidenOp {
        WidenSVecI8x16ToVecI32x4 = 0,
        WidenUVecI8x16ToVecI32x4 = 1
    }
    export enum RefIsOp {
        RefIsNull = 0,
        RefIsFunc = 1,
    ...
    export class Module {
        ...
        useShadowStack: boolean);
        private lit;
        static create(useShadowStack: boolean): Module;
        static createFrom(buffer: Uint8Array, useShadowStack: boolean): Module;
        ...
        local_tee(index: number, value: ExpressionRef, isManaged: boolean, type?: NativeType): ExpressionRef;
        ...
        ref_func(name: string, type: NativeType): ExpressionRef;
...
declare module "assemblyscript/src/passes/pass" {
     ...
     * @license Apache-2.0
     */
    import { Module, ExpressionRef, FunctionRef, GlobalRef, Index, CString } from "assemblyscript/src/module";
...
declare module "assemblyscript/src/passes/rtrace" {
    ...
    import { ExpressionRef, NativeType } from "assemblyscript/src/module";
...
declare module "assemblyscript/src/passes/shadowstack" {
     ...
     */
    import { Pass } from "assemblyscript/src/passes/pass";
    import { ExpressionRef, FunctionRef, Index, BinaryOp, NativeType, ExportRef } from "assemblyscript/src/module";
